	...
	function Round_display(){	
		var enemy_round = document.getElementById("Enemyability_Frame");
		var man_round = document.getElementById("Manability_Frame");
		
		if(round == 1)
		{
			document.getElementById("round").innerHTML = "我方";
			enemy_round.style.borderColor="#FFFFFF";
			man_round.style.borderColor="#FF0000";
			
		}
		else
		{
			document.getElementById("round").innerHTML = "敵方";
			enemy_round.style.borderColor="#FF0000";
			man_round.style.borderColor="#FFFFFF";
		}
		if(monster_HP <= 0)
		{
			enemy_round.style.borderColor="#FFFFFF";
    ...
    function stop() {
		...
		if(mod == 1){	//monster
		...
		else if(mod == 0){	//combat and if monster dead
			man_battleHP = man_HP;
			if(battle > 0 )
			{
			...
			if(monster_HP <= 0){
				...
				Status_TABLE(mod);
				document.getElementById("EnemyAttack_getdiv").innerHTML = "";
				document.getElementById("EnemyHp_getdiv").innerHTML = "";
				document.getElementById("Enemyability_Frame").style.borderColor="#FFFFFF";
				document.getElementById("Manability_Frame").style.borderColor="#FFFFFF";
			}
			battle++;
			Round_display();			
		}		
			...
			if(number >= 3 && number <= 8){ // show the body , treasure , trap mode
